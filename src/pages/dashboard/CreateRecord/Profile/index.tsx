...
export default function Profile() {
  ...
  const handleNext = (consentData: any = {}) => {
    ...
    console.log("before:", consentData);
  };
      ...
      <div className="mt-8">
              ...
              <Box>
                ...
                <Box sx={{ mt: 3 }}>
                  ...
                  <InputField
                    ...
                    onChange={(e: any) =>
                      handleChange("HMOPlan", e.target.value)
                    }
                  />
        ...
        {activeStep === 1 && (
          <Box sx={{ marginTop: 2 }}>
            ...
            <UpdateConsent NHRID={newId} onNext={(data) => handleNext(data)} />
          </Box>
        )}
        ...
        >
          ...
          <Button
            variant="contained"
            // onClick={handleNext}
            onClick={activeStep === 1 ? updateUser : handleNext}
          >
