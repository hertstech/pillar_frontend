...
export default function Overview({ client }: PropType) {
  ...
  return (
    <Box className="flex gap-6">
      <Box className="flex flex-col gap-6" width={"70%"}>
        <Box
          sx={{
            display: "flex",
        ...
        >
          ...
          >
            <Box
              className="flex flex-row justify-between border-1 gap-2 p-4 items-start
               rounded-lg bg-white"
            >
              <div className="">
                ...
                <p className="font-light text-xs text-neu-500">
        ...
        >
          <Box className="w-[50%] bg-white border-1 border-[#E47EC]">
            <Box className="flex justify-between items-center p-4">
              <Typography fontWeight={500} fontSize={12} color="#090816">
                Pulse Rate
              </Typography>

              <span className="p-2 rounded-full bg-red-100 h-fit">
                <FaHeartbeat className="text-err" />
              </span>
            </Box>

            <Divider />

            <Box p={2} sx={{ height: 370, backgroundColor: "#FFF" }}>
          ...
          <Box className="w-[50%] bg-white border-1 border-[#E47EC]">
            <Box className="flex justify-between items-center p-4">
              ...
              <span className="p-2 rounded-full bg-green-100 h-fit">
                <FaHeartCircleCheck className="text-succ" />
              </span>
            </Box>
            <Divider />
            <Box p={2} sx={{ height: 370, backgroundColor: "#FFF" }}>
